                ...
                <FramerMagnetic>
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 448 512"
                      className="group-hover:fill-white h-14 md:h-20 fill-accent transition-all duration-300 intersect-once intersect:motion-preset-blur-up-lg motion-delay-300 motion-duration-1000"
                    >
                ...
                <FramerMagnetic>
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 496 512"
                      className="group-hover:fill-white h-14 md:h-20 fill-accent transition-all duration-300 intersect-once intersect:motion-preset-blur-up-lg motion-delay-400 motion-duration-1000"
                    >
                ...
                <FramerMagnetic>
                  ...
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      className="group-hover:fill-white h-14 md:h-20 fill-accent transition-all duration-300 intersect-once intersect:motion-preset-blur-up-lg motion-delay-500 motion-duration-1000"
                    >
